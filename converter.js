...
class Converter extends Component {
  ...
  getRates() {
    axios.get('http://data.fixer.io/api/latest?access_key=e6673dfb8d67f41209c3158e6345e4b8&symbols=EUR,TRY,USD,CAD,JPY')
      .then(response => {
  ...
  render() {
    ...
    return (
      <View style={converterWrapper}>
        <TextInput placeholder='EURO DEĞERİNİ GİRİNİZ'
                   style={inputStyle}
